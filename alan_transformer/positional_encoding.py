...
class PositionalEncoding(torch.nn.Module):
    ...
    to achieve the desired behavior across the full embedding space. Note also that the authors
    said they theorized that being able to learn fixed relative attention patterns is why interweaved
    sinusoidal positional encodings would work well, so this is likely what they were specifically
    referring to.
    """
